...
public class Utils
{
	...
	public static String ORG_NEUROML_EXPORT_VERSION = "1.4.2";
	...
	public static String getHeaderComment(Formats format)
	{
	...
	public static void loadLemsFile(File f, boolean run) throws LEMSException, ModelFeatureSupportException, NeuroMLException
	{
		...
		if(run)
		{
			...
			sli.checkConversionSupported(Formats.LEMS, sim.getLems());
			sim.run();
