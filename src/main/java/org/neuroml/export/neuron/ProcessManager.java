...
public class ProcessManager
{
    ...
    public static File findNeuronHome() throws NeuroMLException {
        ...
        else if (Utils.isMacBasedPlatform())
        {
            ...
            options.add( "/home/padraig/nrn72pympi/x86_64");  // TODO: remove this hack...
        }

        for (String option: options) {
            File f = new File(option, "bin/nrniv");
            if (f.exists()) return new File(option);
        }
        
        throw new NeuroMLException("Could not find NEURON home directory! Options tried: "+options, null);
    ...
    public static boolean compileFileWithNeuron(File modDirectory, boolean forceRecompile) throws NeuroMLException
    {
        ...
        try
        {
            ...
            if (!forceRecompile)
            {
                ...
                E.info("Going to check if mods in "+modDirectory+"" +
                ...
                if (fileToCheck!=null)
                {
                    ...
                    if (!newerModExists) 
                    {
                        E.info("Not being asked to recompile, and no mod files exist in "+modDirectory+"" +
            ...
            {
                E.info("Unsuccessful compilation. File doesn't exist: "+ fileToBeCreated.getAbsolutePath()
        ...
        catch (Exception ex)
        {
            ...
            throw new NeuroMLException("Error testing: " +
