...
public class NamingHelper
{
	...
	public String getNrnSectionName(Segment seg)
	{
		...
		/*
		 * if (sgVsSegIds.isEmpty()) { String secName = (seg.getName()!=null && seg.getName().length()>0) ? seg.getName() : "section_"+seg.getId(); cachedSectionNames.put(uniqueId, secName); return
		 * secName; }
		 */
