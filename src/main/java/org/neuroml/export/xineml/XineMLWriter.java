...
public class XineMLWriter extends XMLWriter {
    ...
    public static final String PREF_9ML_SCHEMA = "http://sbml.org/Special/xml-schemas/sbml-l2v2-schema/sbml.xsd";
    ...
    public String getMainScript() throws ContentError {
        ...
        String[] attrs = new String[]{"xmlns=http://www.sbml.org/sbml/level2/version2",
            ...
            "xsi:schemaLocation=http://www.sbml.org/sbml/level2/version2 "+PREF_9ML_SCHEMA};
        String root = variant.toString();
        
        startElement(main, root, attrs);
