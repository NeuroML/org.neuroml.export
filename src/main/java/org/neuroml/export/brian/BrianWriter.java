...
public class BrianWriter extends BaseWriter {
    ...
    {
            if(dim.getName().equals("voltage")) return "V";
            if(dim.getName().equals("conductance")) return "S";
        ...
        public void getCompEqns(CompInfo compInfo, Component comp, String popName, ArrayList<String> stateVars, String prefix) throws ContentError, ParseError
        {
        		...
        		for(TimeDerivative td: tds)
        		{
                        ...
                        expr = expr.replace("^", "**");
                        compInfo.eqns.append("    d"+localName+"/dt = "+expr+" : 1\n");
                }
        		...
        		for(DerivedVariable edv: expDevVar)
        		{
        			...
        			expr = expr.replace("^", "**");
        			compInfo.eqns.append("    "+prefix+edv.getName()+" = "+expr+" : 1\n");
        		}
