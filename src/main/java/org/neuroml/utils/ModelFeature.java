...
public enum ModelFeature {
    ...
    private static void analyseSingleComponent(Component component,
            ArrayList<ModelFeature> mfs,
            Lems lems) throws LEMSException, NeuroMLException {
    ...
    public static void main(String[] args) {
        ...
        for (File f : exFileDir.listFiles()) {
            ...
            Collections.addAll(ignores, "NML2_NestedNetworks.nml", 
                                        "NML2_CellVariableParams.nml", 
                                        "NML2_SimpleNetwork3D.nml", 
                                        "NML2_SimpleNetwork.nml",
                                        "NML2_InhomogeneousParams.nml",
                                        "NML2_FullCell.nml");
            try {
