...
public class Testbench {
	...
	public static void writeTestBench(EDSimulation sim, StringBuilder sb)
	{
		...
		sb.append("\r\n" +
				...
				"	signal SelectSpikesIn : STD_LOGIC_VECTOR(4607 downto 0);\r\n" + 
		...
		sb.append("\r\n" + 
				...
				"\r\n" + 
				"begin\r\n" + 
				"SelectSpikesIn <= \"\";\r\n" + 
				"\r\n" + 
				"");
	...
	private static void writeExposureTitlesToFile(StringBuilder sb, EDComponent comp,String name, String parentName)
	{
		...
		for(Iterator<EDExposure> y = comp.exposures.iterator(); y.hasNext(); ) {
			EDExposure exposure = y.next(); 
			sb.append("\r\n" + 
